...
class Flat(models.Model):
    ...
    town_district = models.CharField("Район города, где находится квартира", max_length=50,
                                     blank=True,
...
class Complaint(models.Model):
    name = models.ForeignKey(User, verbose_name="Кто жаловался", on_delete=models.CASCADE)
...
class Owner(models.Model):
    ...
    pure_phone_number = PhoneNumberField(blank=True, verbose_name="Нормализованный номер владельца")
    owned_apartments = models.ManyToManyField(Flat, verbose_name="Квартиры в собственности",
